      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/tracker" className="text-gray-900 font-medium">
              TRACKER
            </Link>
          ...
          {/* Mobile menu button */}
          <button onClick={() => setIsOpen(!isOpen)} className="md:hidden text-gray-600 hover:text-gray-900">
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <Link href="/tracker" className="block px-3 py-2 rounded-md text-gray-900 bg-gray-50">
              TRACKER
            </Link>
            <Link
              href="/products"
