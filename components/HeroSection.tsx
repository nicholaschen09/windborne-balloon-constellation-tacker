      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-10">
        <div className="space-y-8">
          <div>
            ...
            <h1 className="text-3xl lg:text-4xl font-bold text-slate-900 leading-tight">WindBorne Balloon Tracker</h1>
          </div>
          <div className="space-y-3 text-sm text-slate-600 leading-relaxed">
            <p>
              WindBorne builds a planetary-scale weather network. Every balloon reports its full 24h history, and we
              merge that telemetry with NASA&apos;s EONET hazard stream (wildfires, storms, volcanoes, sea-ice).
            </p>
            <p>
              The tracker below is purpose-built for this mission: the UI mirrors the name by foregrounding real-time
              trajectories, drift speeds, and hazard overlays so you instantly understand what the fleet is sampling.
            </p>
          </div>
